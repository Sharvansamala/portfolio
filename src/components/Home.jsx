    ...
    return (
        <div name='home' className='w-full h-screen bg-[#0a192f]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <h2 className='text-4xl sm:text-8xl font-bold text-[#8892b0]'>I'm a Backend Developer.</h2>
                <p className='text-[#8992b0] py-5 max-w-700px text-2xl'>I am a Backend Developer with expertise in AWS, Java, Spring Boot and Microservices.</p>
                <div>
